...
})(undefined, document, function (e, t, n, r) {
  (function (e, t, n, r) {
    function T(e) {
      ...
      e.fn[n] = function (e) {
        ...
        var t,
          ...
          if (e.event.special.swipe.eventInProgress) return;e.event.special.swipe.eventInProgress = !0;var r,
            ...
            if (!o) return;r = e.event.special.swipe.stop(t), l || (l = e.event.special.swipe.handleSwipe(o, r, n, u), l && (e.event.special.swipe.eventInProgress = !1)), Math.abs(o.coords[0] - r.coords[0]) > e.event.special.swipe.scrollSupressionThreshold && t.preventDefault();
          }, s.stop = function () {
    ...
    e.extend(e.mobile, { version: '1.4.3', subPageUrlKey: 'ui-page', hideUrlBar: !0, keepNative: ':jqmData(role=\'none\'), :jqmData(role=\'nojs\')', activePageClass: 'ui-page-active', activeBtnClass: 'ui-btn-active', focusClass: 'ui-focus', ajaxEnabled: !0, hashListeningEnabled: !0, linkBindingEnabled: !0, defaultPageTransition: 'fade', maxTransitionWidth: !1, minScrollBack: 0, defaultDialogTransition: 'pop', pageLoadErrorMessage: 'Error Loading Page', pageLoadErrorMessageTheme: 'a', phonegapNavigationEnabled: !1, autoInitializePage: !0, pushStateEnabled: !0, ignoreContentEnabled: !1, buttonMarkup: { hoverDelay: 200 }, dynamicBaseEnabled: !0, pageContainer: e(), allowCrossDomainPages: !1, dialogHashKey: '&ui-state=dialog' });
  }(e, this), function (e, t, n) {
    var r = {},
        i = e.find,
        s = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
    ...
    function i(e) {
      ...
      var n = t,
        ...
        (!t || !r) && e('html').addClass('ui-nosvg');
          ...
          s = new n.Image();s.onerror = function () {
        i(!1);
      }, s.onload = function () {
      ...
      var i = 'transform-3d',
          ...
          a,
          f,
          l;if (o) return !!o;a = n.createElement('div'), f = { MozTransform: '-moz-transform', transform: 'transform' }, s.append(a);for (l in f) {
      ...
      var t = location.protocol + '//' + location.host + location.pathname + 'ui-dir/',
          ...
          i = '',
          o,
          u;return n.length ? i = n.attr('href') : n = r = e('<base>', { href: t }).appendTo('head'), o = e('<a href=\'testurl\' />').prependTo(s), u = o[0].href, n[0].href = i || location.pathname, r && r.remove(), u.indexOf(t) === 0;
    }function v() {
      var e = n.createElement('x'),
          r = n.documentElement,
          i = t.getComputedStyle,
          s;return 'pointerEvents' in e.style ? (e.style.pointerEvents = 'auto', e.style.pointerEvents = 'x', r.appendChild(e), s = i && i(e, '').pointerEvents === 'auto', r.removeChild(e), !!s) : !1;
    }function m() {
      var e = n.createElement('div');return typeof e.getBoundingClientRect != 'undefined';
    }function g() {
      var e = t,
          ...
          f = !!a && a[1];return (r.indexOf('iPhone') > -1 || r.indexOf('iPad') > -1 || r.indexOf('iPod') > -1) && s && s < 534 || e.operamini && {}.toString.call(e.operamini) === '[object OperaMini]' || a && f < 7458 || n.indexOf('Android') > -1 && s && s < 533 || u && u < 6 || 'palmGetResource' in t && s && s < 534 || n.indexOf('MeeGo') > -1 && n.indexOf('NokiaBrowser/8.5.0') > -1 ? !1 : !0;
        ...
        c;e.extend(e.mobile, { browser: {} }), e.mobile.browser.oldIE = function () {
      var e = 3,
          t = n.createElement('div'),
          r = t.all || [];do {
        t.innerHTML = '<!--[if gt IE ' + ++e + ']><br><![endif]-->';
      } while (r[0]);return e > 4 ? e : !e;
      ...
      var e = t.navigator.userAgent;return e.indexOf('Nokia') > -1 && (e.indexOf('Symbian/3') > -1 || e.indexOf('Series60/5') > -1) && e.indexOf('AppleWebKit') > -1 && e.match(/(BrowserNG|NokiaBrowser)\/7\.[0-3]/);
