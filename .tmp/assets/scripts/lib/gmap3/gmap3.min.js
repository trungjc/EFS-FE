...
!function (t, n) {
  function e(t) {
    ...
    q = google.maps, A || (A = { verbose: !1, queryLimit: { attempt: 5, delay: 250, random: 250 }, classes: function () {
        var n = {};return t.each('Map Marker InfoWindow Circle Rectangle OverlayView StreetViewPanorama KmlLayer TrafficLayer BicyclingLayer GroundOverlay StyledMapType ImageMapType'.split(' '), function (t, e) {
          n[e] = q[e];
        }), n;
    ...
    function a(t) {
      ...
      if (!x && !I && P) {
        var n,
            ...
            E = p();for (M = !1, j > 3 && (s = c(), y = s.getSouthWest().lng() < s.getNorthEast().lng()), n = 0; n < _.length; n++) {
          !_[n] || y && !s.contains(_[n].options.position) || w && !w(D[n]) || b.push(n);
        }for (;;) {
          for (n = 0; B[n] && n < b.length;) {
            n++;
          }if (n === b.length) break;if (r = [], k && !C) {
            m = 10;do {
        ...
        _ = [],
        D = [],
        U = S(o, i.radius);r(), B.getById = function (t) {
      return t in C ? (a(C[t]), T[C[t]]) : !1;
    }, B.rm = function (t) {
      var n = C[t];T[n] && T[n].setMap(null), delete T[n], T[n] = !1, delete _[n], _[n] = !1, delete D[n], D[n] = !1, delete C[t], delete E[n], M = !0;
      ...
      var o,
          ...
          s,
          u = [],
          l = v(e);for (t ? (o = _.length - 1, i = -1, a = -1) : (o = 0, i = _.length, a = 1), r = o; r !== i && (!_[r] || l && !l(_[r].tag) || (u.push(E[r]), !n && !t)); r += a) {}for (s = 0; s < u.length; s++) {
        B.rm(u[s]);
      }
    }, B.add = function (t, n) {
    ...
    function r() {
      ...
      e = e || {};var o = e.td && e.td.options ? e.td.options : 0;S ? o && (o.center && (o.center = m(o.center)), S.setOptions(o)) : (o = e.opts || t.extend(!0, {}, A.map, o || {}), o.center = n || m(o.center), S = new A.classes.Map(i.get(0), o));
    }function w(e) {
      var o,
          a,
          r = new T(i, S, e),
      ...
      var o = [],
        ...
        var s,
            u,
            d = p(n, r),
            c = t(document.createElement('div')).css({ border: 'none', borderWidth: 0, position: 'absolute' });c.append(d.options.content), u = new D(S, d.options, m(d) || m(r), c), o.push(u), c = null, e || (s = I.add(n, 'overlay', u), l(i, { td: d }, u, s));
      ...
      var e,
          ...
          a,
          r = 'values' in n.td,
          u = !S;return r || (n.opts.position = n.latLng || m(n.opts.position), n.td.values = [{ options: n.opts }]), n.td.values.length ? (u && v(), n.td.cluster && !S.getBounds() ? void q.event.addListenerOnce(S, 'bounds_changed', function () {
        x.marker.apply(x, [n]);
        ...
        var o = p(n, e);o.options.position = m(o.options.position ? o.options.position : e), o.options.position && (o.options.map = S, u && (S.setCenter(o.options.position), u = !1), a.add(o, e));
      }), a.endUpdate(), g(n, o)) : (e = [], t.each(n.td.values, function (t, o) {
        var a,
            r,
            s = p(n, o);s.options.position = m(s.options.position ? s.options.position : o), s.options.position && (s.options.map = S, u && (S.setCenter(s.options.position), u = !1), r = new A.classes.Marker(s.options), e.push(r), a = I.add({ td: s }, 'marker', r), l(i, { td: s }, r, a));
      ...
      var o = [],
        ...
        var u,
            d,
            c = p(e, s);c.options.position = m(c.options.position ? c.options.position : s.latLng), S || v(c.options.position), d = new A.classes.InfoWindow(c.options), d && (a(c.open) || c.open) && (r ? d.open(S, c.anchor || n) : d.open(S, c.anchor || (e.latLng ? n : e.session.marker ? e.session.marker : n))), o.push(d), u = I.add({ td: c }, 'infowindow', d), l(i, { td: c }, d, u);
      }), g(e, r ? o : o[0]);
    }, x.circle = function (n) {
      var e = [],
        ...
        var a,
            r,
            s = p(n, o);s.options.center = m(s.options.center ? s.options.center : o), S || v(s.options.center), s.options.map = S, r = new A.classes.Circle(s.options), e.push(r), a = I.add({ td: s }, 'circle', r), l(i, { td: s }, r, a);
      ...
      var e = [],
        ...
        var a,
            r,
            s = p(n, o);s.options.bounds = y(s.options.bounds ? s.options.bounds : o), S || v(s.options.bounds.getCenter()), s.options.map = S, r = new A.classes.Rectangle(s.options), e.push(r), a = I.add({ td: s }, 'rectangle', r), l(i, { td: s }, r, a);
      }), void g(n, o ? e : e[0])) : void g(n, !1);
      ...
      v();var n = I.get('trafficlayer');n || (n = new A.classes.TrafficLayer(), n.setMap(S), I.add(t, 'trafficlayer', n)), g(t, n);
    }, x.bicyclinglayer = function (t) {
      v();var n = I.get('bicyclinglayer');n || (n = new A.classes.BicyclingLayer(), n.setMap(S), I.add(t, 'bicyclinglayer', n)), g(t, n);
    }, x.groundoverlay = function (t) {
      t.opts.bounds = y(t.opts.bounds), t.opts.bounds && v(t.opts.bounds.getCenter());var n,
          e = new A.classes.GroundOverlay(t.opts.url, t.opts.bounds, t.opts.opts);e.setMap(S), n = I.add(t, 'groundoverlay', e), g(t, e, n);
      ...
      n.opts.opts || (n.opts.opts = {}), n.latLng ? n.opts.opts.position = n.latLng : n.opts.opts.position && (n.opts.opts.position = m(n.opts.opts.position)), n.td.divId ? n.opts.container = document.getElementById(n.td.divId) : n.opts.container && (n.opts.container = t(n.opts.container).get(0));var e,
          o = new A.classes.StreetViewPanorama(n.opts.container, n.opts.opts);o && S.setStreetView(o), e = I.add(n, 'streetviewpanorama', o), g(n, o, e);
      ...
      var e = [],
        ...
        var a,
            r,
            s,
            d = p(n, o);S || v(), s = d.options, d.options.opts && (s = d.options.opts, d.options.url && (s.url = d.options.url)), s.map = S, r = u('3.10') ? new A.classes.KmlLayer(s) : new A.classes.KmlLayer(s.url, s), e.push(r), a = I.add({ td: d }, 'kmllayer', r), l(i, { td: d }, r, a);
      }), void g(n, o ? e : e[0])) : void g(n, !1);
    }, x.panel = function (n) {
      v();var e,
          o,
      ...
      v();var n = new A.classes.StyledMapType(t.td.styles, t.opts);S.mapTypes.set(t.td.id, n), g(t, n);
    }, x.imagemaptype = function (t) {
      v();var n = new A.classes.ImageMapType(t.opts);S.mapTypes.set(t.td.id, n), g(t, n);
      ...
      var r,
          s,
          u = i ? e : e.td;return i || (a = u.full), o(u) ? (s = I.getById(u, !1, a) || I.objGetById(u), s === !1 && (r = u, u = {})) : r = u.name, 'map' === r && (s = S), s || (s = [], u.id ? (t.each(h(u.id), function (t, n) {
      ...
      if (o(n.td)) q.event.trigger(S, n.td);else {
        var e = [S, n.td.eventName];n.td.var_args && t.each(n.td.var_args, function (t, n) {
          e.push(n);
    ...
    var n,
      ...
      var n = t(this),
          a = n.data('gmap3');o = !1, a || (a = new U(n), n.data('gmap3', a)), 1 !== e.length || 'get' !== e[0] && !x(e[0]) ? a._plan(e) : i.push('get' === e[0] ? a.get('map', !0) : a.get(e[0].get, !0, e[0].get.full));
